                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject bold uppercase">Add Reward</span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="{{ url('admin/reward/add/post') }}" class="form-horizontal" method="POST" enctype="multipart/form-data" onSubmit="return validate();">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Name</label>
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Reward name" name="nama_reward" required> 
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <textarea  class="form-control" placeholder="Description" name="deskripsi" cols="80" rows="5" required></textarea> 
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">

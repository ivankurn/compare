...
function initialize() {
  var haightAshbury = new google.maps.LatLng(<?php echo $store[0]['latitude']; ?>,<?php echo $store[0]['longitude']; ?>);
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject bold uppercase">Edit {{ $su['nama_store'] }} Store</span>
                        </div>
                    </div>
                        ...
                        <form action="{{ url('admin/store/add/post') }}" class="form-horizontal" method="POST">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Store name" name="name_store" required value="{{ $su['nama_store'] }}"> 
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Slug store" value="{{ $su['slug_store'] }}" name="slug_store" required> 
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <textarea  class="form-control" placeholder="Address store" name="alamat" cols="80" rows="5" required>{{ $su['alamat_store'] }}</textarea> 
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        ...
                                        <select id="provinsi_store" class="form-control select2" name="provinsi_store" required>
                                            <option value="">-- Choose Province --</option>
                                            @foreach($provinsi as $yu)
                                            <option value="{{ $yu['id_provinsi'] }} | {{ $yu['nama_provinsi'] }}"> {{ $yu['nama_provinsi'] }} </option>
                                            @endforeach
                                        </select>
                                       
                                    </div>
                                </div>
                                <div class="form-group" id="kotanyastore">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Pos code store" value="{{ $su['kodepos_store'] }}" name="kodepos_store" required> 
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="phone store" value="{{ $su['phone_store'] }}" name="phone_store" required> 
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <input type="text" class="form-control timepicker timepicker-24 input-sm " name="jam_buka" value="{{ $su['jam_buka'] }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group select2-bootstrap-prepend col-md-7">
                                        <div class="input-group">
                                            <input type="text" class="form-control timepicker timepicker-24 input-sm " name="jam_tutup"  value="{{ $su['jam_tutup'] }}" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-4">
                                        ...
                                        <input type="hidden" name="id_store" value="{{ $su['id_store'] }}">
